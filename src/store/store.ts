...
import {REQUIREMENTS, SIDE_BAR_VISIBLE, NEW_CARD_VISIBLE} from '@/store/getter-types';
import {FETCH_REQUIREMENTS} from '@/store/action-types';
import {SET_REQUIREMENTS, TOOGLE_SIDEBAR, TOOGLE_NEWCARD} from '@/store/mutation-types';
